    ...
    <header className="sticky top-0 z-50 w-full border-b border-gray-200 dark:border-gray-800 bg-white/70 dark:bg-gray-900/70 backdrop-blur-md transition-colors duration-500">
      <div className="max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6 py-2 sm:py-3">
        ...
        <div className="flex items-center gap-2">
          <Link
            href="/"
            className="flex items-center gap-2 text-lg sm:text-xl font-extrabold text-indigo-600 dark:text-indigo-400 no-underline hover:opacity-80 transition-colors duration-300"
          >
            🎮 Havena Store
          </Link>
        </div>
